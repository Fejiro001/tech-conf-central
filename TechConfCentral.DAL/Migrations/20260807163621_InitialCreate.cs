        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFeatured = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    IsKeynote = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SavedTalk", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SavedTalk_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SavedTalk_Talk_TalkId",
                        column: x => x.TalkId,
                        principalTable: "Talk",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedTalk_TalkId",
                table: "SavedTalk",
                column: "TalkId");

            migrationBuilder.CreateIndex(
                name: "IX_SavedTalk_UserId_TalkId",
                table: "SavedTalk",
                columns: new[] { "UserId", "TalkId" },
                unique: true);
